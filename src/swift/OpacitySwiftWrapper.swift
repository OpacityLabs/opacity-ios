...
public class OpacitySwiftWrapper {
  ...
  public static func initialize(apiKey: String, dryRun: Bool, environment: Environment) throws {
    let environment = OpacityEnvironment(rawValue: environment.rawValue) ?? OpacityEnvironment.Production
  ...
  public static func get(name: String, params: [String: Any]?) async throws -> [String: Any] {
